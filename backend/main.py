...
# ---------------------------------------------------------------------------
# GNN scheduler — writes directly to JSON store (no HTTP round-trip)
# ---------------------------------------------------------------------------
def run_gnn_analysis():
    ...
    print(f"[GNN] Saved {min(3, len(fraud_candidates))} fraud alert(s)")
    ...
    try:
        ...
        if is_anomaly:
            if data.temperature > 100:
                ...
                recommendation = "ALERT: AI detected anomaly pattern."
