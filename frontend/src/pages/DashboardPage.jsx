...
const DashboardPage = () => {
  ...
  // ✅ Real bar chart from /api/history/all
  const fetchChartData = async (period) => {
    try {
      ...
      console.log('History API not available, using fallback chart');
      setChartData(generateFallbackChart(period));
    }
  };
