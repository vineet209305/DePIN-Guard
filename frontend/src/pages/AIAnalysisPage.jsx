...
const AIAnalysisPage = () => {
  ...
  useEffect(() => {
    if (selectedModel === 'All Models') setFilteredResults(analysisResults);
            ...
            {filteredResults.map((analysis) => (
              <div key={analysis.id} className="analysis-card">
                <div className="analysis-header">
                  ...
                  <div className="severity-badge" style={{ background: getSeverityColor(analysis.severity).bg, color: getSeverityColor(analysis.severity).text }}>
